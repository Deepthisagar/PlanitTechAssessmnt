Feature: Contact Page Validation
  ...
  Scenario: Validating successful submission message
    ...
    And at contact page - user validates successful submnission message
  ...
  Scenario: Validating successful submission message
    ...
    And navigates to contact page
    And user verifies contact page is loaded
    And at contact page - user enters Forename as "123345"
    And at contact page - user enters email as "1233445"
    And at contact page - user enters message as "   "
    And at contact page - user validates the error